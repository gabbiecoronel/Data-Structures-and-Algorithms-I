...
// intitialize the total number of valid orderings (total number of permutations)
int totalValidOrderings = 0;
...
void permutation(int perm[], int used[], int n, int maxNumPeople)
{
    ...
    if (n == maxNumPeople)
    {
        ...
        {
            // total number of valid orderings incereases by 1
            totalValidOrderings+=1;
        }
        // return to the most recent call
        return;
    }
